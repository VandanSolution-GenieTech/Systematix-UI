<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Currentallocation.aspx.cs" Inherits="Currentallocation" %>
    ...
    <div class="row">
        <div class="col-lg-10 mb-1">
            ...
            <div class="page-header row no-gutters py-3">
                <h3 class="page-title fontstyle">Current Allocation</h3>
                ...
                <div class="dataTables_length">
                    <table id="example" class="table mb-0 stripe row-border order-column" style="width: 100%">
                        ...
                        <thead class="bg-light" >
                            <tr class="gridheader ">
                                <th style="text-transform: capitalize;" class="txt_left fontstyle " scope="col ">CM Code</th>
                                <th style="text-transform: capitalize;" class="txt_left fontstyle " scope="col">TM / CP Code</th>
                                ...
                                <th style="text-transform: capitalize;" class="txt_left fontstyle " scope="col">Cash Allocated</th>
                            </tr>
                        ...
                        <tbody>
                            <asp:Repeater ID="Repeater1" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        <td style="text-transform: capitalize;" scope="col" class="txt_left fontstyle"><%# DataBinder.Eval(Container.DataItem, "CMcode") %></td>
                                        <td style="text-transform: capitalize;" scope="col" class="txt_left fontstyle"><%# DataBinder.Eval(Container.DataItem, "TMCPcode")%></td>
                                        ...
                                        <td style="text-transform: capitalize;" scope="col" class="txt_left fontstyle"><div class="Comma"><%# DataBinder.Eval(Container.DataItem, "Cashallocated") %></div></td>
