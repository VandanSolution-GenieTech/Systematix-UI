...
<div class="row">
 <div class="col-lg-11 mb-1">            
            ...
            <div class="page-header row no-gutters py-3">
					<h3 class="page-title fontstyle">HDFC Report</h3> <span class="page-subtitle" style="vertical-align:text-bottom;">&nbsp;</span>              
				</div>
 ...
 <div class="page-header row no-gutters py-3">
  ...
  <asp:Button runat="server" ID="export" Text="Download" 
              ...
              <label>
                <span class="ml-auto text-right text-semibold text-reagent-gray">
                  <div id="Div3" class="input-group input-group-sm my-auto ml-auto mr-auto ml-sm-auto mr-sm-0" style="max-width: 350px;">
                     <asp:Button runat="server" ID="Submit" class="mb-2 btn button_brand mr-2" Text="Submit"/>
                  </div>
                </span>
          ...
          <ItemTemplate>
								 <tr>
                                                        ...
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "TraderId")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "TraderName")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "TraderPan")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "GreekId")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "Email")%></td>
                                                        <td scope="col" class="text-center"><%# DataBinder.Eval(Container.DataItem, "JoiningDate","{0:yyyy-MM-dd}")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "mobile")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "status")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "EmergencyContact")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "InterestBase")%></td>
                                                        <td scope="col" class="txt_left"><%# DataBinder.Eval(Container.DataItem, "Address")%></td>
                                                        <th scope="col" class="text-center">
                                                            <asp:Button runat="server" ID="Edit" Text="Edit" CommandArgument='<%#Eval("id") %>'  onclick="edit_Click" style="background:rgb(14, 175, 226);color:white;border-color:rgb(14, 175, 226)" Font-Bold="true"/>
                                                            <asp:Button runat="server" ID="Delete" Text="Delete" CommandArgument='<%#Eval("id") %>' onclick="delete_Click" style="background:rgb(14, 175, 226);color:white;border-color:rgb(14, 175, 226)" Font-Bold="true" /></th>--%>
                                                    </tr>
