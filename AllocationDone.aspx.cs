...
public partial class AllocationDone : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            cmd = new SqlCommand("Select id,Format(Dt , 'yyyy-MM-dd') as dt,ClientCode,(Select top 1 C.DPAccountName from ClientwiseDPDetails C where C.AccountCode = I.ClientCode ) as Clientname,Amt,Segment,BeforeAmount from ICCLSends I\r\n", conV);
